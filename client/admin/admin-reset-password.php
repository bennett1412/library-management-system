...
<div class="flex justify-center">
    <div class="w-4/12 bg-white p-6 rounded-lg mt-5">
        ...
        <br>
        <form action="admin-reset-request.php" method="post">
            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-grey-darker" type="text" name="email" placeholder="Enter your e-mail ID "><br><br>
