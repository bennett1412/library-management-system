...
function updateBook($conn, $B_NO,$BOOK_NAME,$AUTHOR,$PUBLISHER_NAME,$CATEGORY_NAME,$COPIES)
{
    $sql = 'UPDATE books SET BOOK_NAME = ?, AUTHOR = ?, PUBLISHER_NAME = ?, CATEGORY_NAME = ?, COPIES = ? WHERE B_NO = ?;';
    $stmt = mysqli_stmt_init($conn);
    ...
    mysqli_stmt_bind_param($stmt, "isssss", $B_NO,$BOOK_NAME,$AUTHOR,$PUBLISHER_NAME,$CATEGORY_NAME,$COPIES);
    mysqli_stmt_execute($stmt);
    mysqli_stmt_close($stmt);
    unset($_SESSION['B_NO']);
...
// update a book
// function updateBook($conn, $bno,$book_name, $author_name, $publisher_name, $category_name, $copies)
// {
//     $sql = 'UPDATE books SET BOOK_NAME = ?, AUTHOR = ?, PUBLISHER_NAME = ?, CATEGORY_NAME= ?, COPIES = ? WHERE B_NO = ?;';
//     $stmt = mysqli_stmt_init($conn);
//     session_start();
...
//         exit();
//     }
//     mysqli_stmt_bind_param($stmt, "sssssi", $book_name, $author_name, $publisher_name, $category_name, $copies, $bno);
//     mysqli_stmt_execute($stmt);
//     mysqli_stmt_close($stmt);
//     $updatedBook = grabBook($conn);
//     $_SESSION["book_name"] = $updatedBook["book_name"];
//     $_SESSION["author_name"] = $updatedBook["author_name"];
//     $_SESSION["publisher_name"] = $updatedBook["publisher_name"];
//     $_SESSION["category_name"] = $updatedBook["category_name"];
//     $_SESSION["copies"] = $updatedBook["copies"];
//     // echo($_SESSION["name"]);
//     // die($_SESSION["id"]);
//     header("location: ../edit-booklist.php?error=none");
//     exit();
...
function updateUser($conn, $name, $email, $mobile,$id)
{
    ...
    header("location: ../listusers.php?error=none");
    exit();
>>>>>>> c1b914d922ad47505c0915c29883349d9c7ee05c
}